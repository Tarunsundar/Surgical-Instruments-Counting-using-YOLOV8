...
def main():
    ...
    # Webcam setup
    cap = cv2.VideoCapture("Instruments/Sample.mp4")  # or use cv2.VideoCapture("video.mp4")
    ...
    # Load YOLOv8n model
    model = YOLO("runs/detect/train12/weights/best.pt")  # replace with your trained weights if needed
